...
class _AdminOrdersScreenState extends State<AdminOrdersScreen> {
  ...
  Future<void> _updateStatus(String orderId, String newStatus,
    ...
    if (newStatus == 'active') {
      ...
      await _addAdminNotif(
          'Order $orderId has been started.', 'order_started', orderId);
      ...
      await _addAdminNotif(
          'Order $orderId has been completed.', 'order_completed', orderId);
    }
  }
  ...
  Future<void> _addAdminNotif(
      String message, String type, String orderId) async {
      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                _TabBtn(label: 'Incoming', selected: _tab == 0,
                    onTap: () => setState(() => _tab = 0)),
                Container(width: 1, height: 20,
                    color: _aBrown.withOpacity(0.2)),
                _TabBtn(label: 'Active', selected: _tab == 1,
                    onTap: () => setState(() => _tab = 1)),
                Container(width: 1, height: 20,
                    color: _aBrown.withOpacity(0.2)),
                _TabBtn(label: 'History', selected: _tab == 2,
  ...
  Widget _buildList(String status,
      {bool canStart = false, bool canReady = false}) {
          ...
          itemBuilder: (ctx, i) {
            ...
            return _AdminOrderCard(
              ...
              onTapDetail: () => _showItemDetail(
                  context, orderId, custName, items, total,
                  canStart: canStart, canReady: canReady,
                  customerId: customerId),
            );
          },
        );
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (milk != null || sweet != null ||
                      extras.isNotEmpty || specialInstruction != null) ...[
                    const SizedBox(height: 10),
                    ...
                    _Row2Col('Milk type', milk ?? 'None',
                        'Size', 'Regular'),
                    const SizedBox(height: 4),
                    _Row2Col('Sweetener', sweet ?? 'None',
                        'Toppings',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(canStart ? 'Start Order' : 'Mark as Ready',
                        style: const TextStyle(
                            color:      Colors.white,
                            fontSize:   15,
                            fontWeight: FontWeight.w700)),
